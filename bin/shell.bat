...
set CLASSPATH=%KARAF_HOME%\system\org\apache\karaf\shell\org.apache.karaf.shell.console\\2.4.0.redhat-630495\org.apache.karaf.shell.console-2.4.0.redhat-630495.jar
